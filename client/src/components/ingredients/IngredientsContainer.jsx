...
class IngredientsContainer extends Component {
  constructor(props) {
    ...
    this.updateIngredients = (event, ingredient) => {
      console.log('updateIngredients!!!!!!!', event, ingredient);
      // exists in selected ingredients & searchbox containers
      // sends updated ingredients list to server updates state
  ...
  componentWillMount() {
    this.updateIngredients('load', 'null');
  }
